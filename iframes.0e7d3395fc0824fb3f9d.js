...
var isBuffer = __webpack_require__(342);
...
var buildURL = __webpack_require__(347);
var parseHeaders = __webpack_require__(348);
var isURLSameOrigin = __webpack_require__(349);
var createError = __webpack_require__(135);
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(350);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(351);
...
var enhanceError = __webpack_require__(346);
...
var utils = __webpack_require__(18);
var bind = __webpack_require__(132);
var Axios = __webpack_require__(343);
...
axios.spread = __webpack_require__(358);
...
var defaults = __webpack_require__(94);
var utils = __webpack_require__(18);
var InterceptorManager = __webpack_require__(352);
var dispatchRequest = __webpack_require__(353);
...
var utils = __webpack_require__(18);
var transformData = __webpack_require__(354);
var isCancel = __webpack_require__(136);
var defaults = __webpack_require__(94);
var isAbsoluteURL = __webpack_require__(355);
var combineURLs = __webpack_require__(356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(340);
...
var handleSucess = function handleSucess(location, moduleName, _ref) {
  var manifest = _ref.data;
  console.log('Module\'s manifest configuration loaded:', manifest);
  var iframe = document.createElement('iframe');
  var div = document.createElement('div');
  var directory = location.split(/\//)[0];
...
var handleLoadManifestSucess = function handleLoadManifestSucess(_ref2) {
  var manifest = _ref2.data;
  console.log('Manifest configuration loaded:', manifest);
  var modules = Object.getOwnPropertyNames(manifest);
  modules.forEach(function (moduleName) {
    if (manifest[moduleName] && manifest[moduleName].manifest) {
      loadModuleManifest(manifest[moduleName].manifest, moduleName);
    }
  });
};

var loadManifest = function loadManifest() {
  return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get("manifest.json").then(handleLoadManifestSucess).catch(handleError);
};

var loadModuleManifest = function loadModuleManifest(manifestLocation, moduleName) {
  return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(manifestLocation).then(handleSucess.bind(_this, manifestLocation, moduleName)).catch(handleError);
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=iframes.0e7d3395fc0824fb3f9d.js.map